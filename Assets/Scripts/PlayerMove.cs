...
public class PlayerMove : MonoBehaviour {
	...
	public bool direction = true, leftOrRight, slide = false, turnPlayer = false;
	...
	void Update () {
		...
		if (!dialogMode) {
			...
			if (Input.GetKey (KeyCode.S)) {
				...
				//player is sliding and the character collider should get smaller
				player.height = 3.5f;
	...
	void OnTriggerEnter(Collider trigger){
		if (trigger.gameObject.tag == "MovingPlateform") {
